        ...
        <React.Fragment>
           <div id="mySidenav" className="sidenav ">
                ...
                <div className='divgrop '>
                    <Link id='link' to='/dashboard'className='text-nowrap'  onClick={()=>getWhatToShow(DASH_BOARD)} > <i className="fa fa-home"></i> Dashboard </Link>
                    </div>

                        <div className='admin text-secondary  px-4 py-4 disabled'> Admin Panel </div>

                        <li  className='lin '><Link id='link' className='mx-1 text-center'  to='/allStakeHolders' onClick={()=>getWhatToShow(ALL_STAKE_HOLDERS)}><i className="far fa-user mx-2"></i> All Stakeholders</Link> </li>
                           <li className='lin'> <Link id='link' className='mx-1 text-center'   to='/manageAllStakeHolders' onClick={()=>getWhatToShow(MANAGE_STAKE_HOLDERS)} > <i className="far fa-users mx-2"></i> Manage Stakeholders</Link> </li>
