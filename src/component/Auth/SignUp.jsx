                    ...
                    <form onSubmit={submit} >
                        ...
                        <div className='row'>
                            <div className='col-12 col-lg-6 col-md-6 form-group '>
                                ...
                                <input type="text" onChange={onChange} name="firstName" value={stateValue.firstName} className='form-control' required placeholder='First-Name'/>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6 form-group '>
                                <label htmlFor="LastName" className='text p-2'>Last-Name</label>
                                <input type="text" onChange={onChange} name="lastName" value={stateValue.lastName} className='form-control' required placeholder='Last-Name'/>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6 form-group '>
                                <label htmlFor="Email" className='text p-2'>Email-Address</label>
                                <input type="email" onChange={onChange} name="email" value={stateValue.email} className='form-control' required placeholder='zikii@gmail.com'/>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6 form-group '>
                                <label htmlFor="Phone" className='text p-2'>Phone-Nmuber</label>
                                <input type="number" onChange={onChange} name="phoneNumber" value={stateValue.phoneNumber} className='form-control' required placeholder='07028292200'/>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6  form-group '>
                            <label htmlFor="State" className='p-2'>State-Of-Origin</label>
                            <select name="state" selected onChange={onChange} value={stateValue.state || ''}   className=' mb-3 form-control' >
                               <Options type='state'/>
                                 </select>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6  form-group '>
                            <label htmlFor="Local-govername" className='p-2'>Local-Government</label>
                            <select name="localGovernment" selected onChange={onChange} value={stateValue.localGovernment || ''}   className=' mb-3 form-control' >
                            <Options type='lga' state={stateValue.state} />
                                 </select>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6 form-group '>
                                <label htmlFor="Ward" className='text p-2'>Ward</label>
                                <input type="text" onChange={onChange} value={stateValue.ward} name="ward" className='form-control' required placeholder='Abijo'/>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6 form-group '>
                                <label htmlFor="district" className='text p-2'>District</label>
                                <input type="text" onChange={onChange} value={stateValue.district} name="district" className='form-control' required placeholder='Abijo'/>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6  form-group '>
                            <label htmlFor="religion" className='p-2'>Select-Religion</label>
                            <select name="religion" value={stateValue.religion} selected onChange={onChange}   className=' mb-3 form-control' >
                            ...
                            <div className='col-12 col-lg-6 col-md-6 form-group '>
                                ...
                                <input type="date" onChange={onChange} value={stateValue.date} name="date" className='form-control' required placeholder='MM/DD/YY'/>
                            </div>
                            <div className='col-12 col-lg-6 col-md-6 form-group '>
                                <label htmlFor="password" className='text p-2'>Password</label>
                                <input type="password" onChange={onChange} value={stateValue.password} name="password" className='form-control' required placeholder='*****'/>
                            </div>
                            <div className='col-12 my-3 my-lg-3 my-md-3 col-lg-6 col-md-6 form-group '>
                                ...
                                <input type="password" onChange={onChange} value={stateValue.confirmPassword} name="confirmPassword"  className='form-control' required placeholder='*****'/>
                            </div>
