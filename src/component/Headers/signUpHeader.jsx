...
function SignUpHead(){
    ...
    return(
        <React.Fragment>
            ...
            <Link to='/signin'  style={{textDecoration:'none'}}   > <i style={{fontSize:'1.2rem', fontWeight:'bold'}} className="fa fa-chevron-left mx-1 text-success " aria-hidden="true"></i> <span className='text-success' style={{fontSize:'1rem', fontWeight:'500'}}>Sign In</span> </Link>
